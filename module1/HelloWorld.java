...
public class HelloWorld extends PApplet
{
	...
	// called right after application is called
	// sets up screne
	public void setup() {
		...
		this.background(700, 500, 60);
		this.fill(204, 800, 0);
		this.rect(0, 20, 550, 60);
		...
		map1 = new UnfoldingMap(this, 20, 50, 350, 500, provider);
	    ...
	    // parameters are the coordinates of where map will be drawn on applet
		map2 = new UnfoldingMap( this, 400, 50, 350, 500, provider);
		// GPS location. latitude and longitude
		map2.zoomAndPanTo( zoomLevel, new Location(26.25, -80.29));
